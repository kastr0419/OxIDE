...
// USB id tables extracted for board presets
use super::UsbId;

pub const UNO_USB_IDS: &[UsbId] = &[
...
pub const LEONARDO_USB_IDS: &[UsbId] = &[
...
pub const RPI_PICO_USB_IDS: &[UsbId] = &[
...
pub const ARDUINO_DUE_USB_IDS: &[UsbId] = &[
...
pub const NRF52840_USB_IDS: &[UsbId] = &[
