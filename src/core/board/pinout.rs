...
static ARDUINO_UNO_PINS: &[PinInfo] = &[
    ...
    PinInfo {
        number: 3,
        name: "D3~",
        functions: &[PinFunction::Gpio, PinFunction::Pwm],
        x: 0.27,
        y: 0.04,
    },
    PinInfo {
    ...
    PinInfo {
        number: 10,
        name: "D10~/SS",
        functions: &[PinFunction::Pwm, PinFunction::Spi],
        x: 0.72,
        y: 0.04,
    },
    PinInfo {
    ...
    PinInfo {
        number: 12,
        name: "D12/MISO",
        functions: &[PinFunction::Gpio, PinFunction::Spi],
        x: 0.85,
        y: 0.04,
    },
    PinInfo {
    ...
    PinInfo {
        number: 14,
        name: "A0",
        functions: &[PinFunction::Adc, PinFunction::Gpio],
        x: 0.58,
        y: 0.96,
    },
    PinInfo {
    ...
    PinInfo {
        number: 18,
        name: "A4/SDA",
        functions: &[PinFunction::Adc, PinFunction::I2C],
        x: 0.83,
        y: 0.96,
    },
    PinInfo {
...
static MICROBIT_PINS: &[PinInfo] = &[
    ...
    PinInfo {
        number: 0,
        name: "P0",
        functions: &[PinFunction::Gpio, PinFunction::Adc],
        x: 0.10,
        y: 0.92,
    },
    PinInfo {
    ...
    PinInfo {
        number: 19,
        name: "P19/SCL",
        functions: &[PinFunction::Gpio, PinFunction::I2C],
        x: 0.88,
        y: 0.78,
    },
    PinInfo {
...
static ESP32_PINS: &[PinInfo] = &[
    ...
    PinInfo {
        number: 32,
        name: "GPIO32",
        functions: &[PinFunction::Gpio, PinFunction::Adc, PinFunction::Pwm],
        x: 0.06,
        y: 0.43,
    },
    PinInfo {
    ...
    PinInfo {
        number: 14,
        name: "GPIO14",
        functions: &[PinFunction::Gpio, PinFunction::Adc, PinFunction::Spi],
        x: 0.06,
        y: 0.76,
    },
    PinInfo {
    ...
    PinInfo {
        number: 5,
        name: "GPIO5/SS",
        functions: &[PinFunction::Gpio, PinFunction::Spi, PinFunction::Pwm],
        x: 0.94,
        y: 0.65,
    },
    PinInfo {
        number: 17,
        name: "GPIO17",
        functions: &[PinFunction::Gpio, PinFunction::Uart],
        x: 0.94,
        y: 0.71,
    },
    PinInfo {
