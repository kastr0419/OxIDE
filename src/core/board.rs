...
pub const BOARD_PRESETS: &[BoardPreset] = &[
    ...
    BoardPreset {
        ...
        rustflags: &["-C", "link-arg=-Tlink.x"],
        flash_offset: 0,
        memory_layout: Some(MemoryLayout { flash_origin: 0x08000000, flash_length_kb: 1024, ram_origin: 0x20010000, ram_length_kb: 320 }),
    },
    BoardPreset {
        ...
        rustflags: &["-C", "link-arg=-Tlink.x"],
        flash_offset: 0,
        memory_layout: Some(MemoryLayout { flash_origin: 0x08000000, flash_length_kb: 2048, ram_origin: 0x20000000, ram_length_kb: 128 }),
    },
    BoardPreset {
